...
R package and shiny application for dive planification tools. It represent a part of the [DiveR package](https://github.com/gowachin/DiveR) and simplify it's usage.
...
This package depend on the [DiveR package](https://github.com/gowachin/DiveR). It can be installed with the following code. *Note that this package also have dependencies described on its own README.*
...
Go check the [projects](https://github.com/gowachin/shinyDiveR/projects) of this repository ! Any help is welcome and I accept all sort of ideas for future project. The idea of this package is to learn about process like desaturation models and turn them into algorithms. If you want to use a specific model, join me and we can try to implement it !
